...
**NOTA IMPORTANTE:**
Esta sección documenta el cierre CONVERSACIONAL (soft close mediante prompts del AI Employee).
Para cierre TÉCNICO de conversaciones (marcar como "closed" en Bird Dashboard y remover del Inbox activo), consulta:
`/docs/bird/bird-conversation-closure-guide.md`

El cierre conversacional (prompts) y el cierre técnico (Flows) pueden combinarse para mejor UX:
- Cierre conversacional: AI Employee envía mensaje de despedida
- Cierre técnico: Flow marca conversación como "closed" después de inactividad
```
