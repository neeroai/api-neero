...
For configuring automatic closure of inactive conversations, see the dedicated guide:

**Guide:** `/docs/bird/bird-conversation-closure-guide.md`

**Features:**
- Template Flow "Nudge and Close Idle Conversations"
- Step-by-step configuration (10-20 min)
- Testing and validation
- Flow execution monitoring
- Patterns by AI Employee type (transactional vs consultative)

**Time:** 10-20 minutes
**Prerequisites:** AI Employee configured, Bird Workflows access

**Related Docs:**
- `/docs/bird/bird-abandonment-explained.md` - Abandonment system deep dive
- `/docs/bird/bird-flows-patterns.md` - More Flow automation patterns
